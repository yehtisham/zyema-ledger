...
Live demo: ledgersmart-web.netlify.app
...
LayerTechnologyBackendPython, FastAPI, SQLAlchemy, SQLiteMLscikit-learn, statsmodels, pandas, numpyFrontendReact, Vite, RechartsAIAnthropic Claude APIDeploymentRender (backend), Netlify (frontend)
...
Excel/CSV → ETL (migrate.py) → SQLite (Render persistent disk)
                    ...
                    /predict-category  /forecast  /backtest
